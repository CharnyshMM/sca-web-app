...
class CustomQueryView(APIView):
    ...
    def get(self, request):
        ...
        try:
            result = NeoQuerier().run_cypher_query(
                request.query_params[CUSTOM_QUERY_REQUEST_PARAMETER])
...
class GetStatusView(APIView):
    ...
    def get(self, request):
        try:
            ...
            publications_count = NeoQuerier().get_nodes_count(
                NeoQuerier.PUBLICATION_NODE_LABEL)
...
class DomainTokensView(APIView):
    renderer_classes = (JSONRenderer,)
    ...
    def get(self, request):
        try:
             ...
             result = NeoQuerier().get_domain_tokens(domain_id)
    ...
    def get(self, request):
        ...
        try:
            if wanted_popularity == 'nascent':
                ...
                result = NeoQuerier().get_domains_by_popularity_index(
                    POPULARITY_INDEX, higher=False)
            return Response(result)
        except GraphError as e:
            print(e)
            return Response(getErrorResponce(str(e)), status=HTTP_400_BAD_REQUEST)
...
class SearchView(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        try:
            ...
            print("limit", limit)
            print("offset", offset)
            result = neo.find_nodes_by_name(
                name, skip_n=offset, limit_n=limit, node_type=node_type)
            return Response(result)
...
class PublicationsSearchView(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        try:
            ...
            print("limit", limit)
            print("offset", offset)
            result = neo.find_publications(
                name, requested_themes_ids=themes, requested_authors_ids=authors, skip_n=offset, limit_n=limit)
            return Response(result)
        except ValueError as e:
            print(e)
            return Response(getErrorResponce("value and limit must be numeric"), status=HTTP_400_BAD_REQUEST)
...
class AuthorsSearchView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            limit = int(request.query_params.get("limit"))
            offset = int(request.query_params.get("offset"))
            result = neo.find_authors(
                name, requested_themes=themes, skip_n=offset, limit_n=limit)
