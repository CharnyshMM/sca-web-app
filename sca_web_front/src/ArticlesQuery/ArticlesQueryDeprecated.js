      ...
      <div className="container">
        ...
        <form className="form" onSubmit={handleSubmit}>
          <div className="form-group input-group">
            <input type="text" className="form-control" placeholder="Token" value={this.state.keywordInputValue} onChange={changeKeywordInput} aria-describedby="using" />
          ...
          <p><small id="using">Enter a token and type <kbd>;</kbd>, <kbd>,</kbd> or <kbd>.</kbd> to add it to the list. Click on keyword to remove it from the list.</small></p>
